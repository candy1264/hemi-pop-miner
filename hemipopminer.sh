...
# 功能1：下载、解压缩并运行帮助命令
download_and_setup() {
    wget https://github.com/hemilabs/heminetwork/releases/download/v0.6.0/heminetwork_v0.6.0_linux_amd64.tar.gz -O heminetwork_v0.6.0_linux_amd64.tar.gz
    ...
    mv "$TARGET_DIR/heminetwork_v0.6.0_linux_amd64/"* "$TARGET_DIR/"
    rmdir "$TARGET_DIR/heminetwork_v0.6.0_linux_amd64"
...
# 功能6：更新到 v0.6.0
update_to_v038() {
    echo "开始更新到 v0.6.0 / Starting update to v0.6.0"
    ...
    # 下载并解压 v0.6.0 版本
    echo "下载 v0.6.0 版本的压缩包... / Downloading v0.6.0 version archive..."
    wget https://github.com/hemilabs/heminetwork/releases/download/v0.6.0/heminetwork_v0.6.0_linux_amd64.tar.gz -O /tmp/heminetwork_v0.6.0_linux_amd64.tar.gz

    echo "解压 v0.6.0 版本的压缩包到 heminetwork 文件夹... / Extracting v0.6.0 version archive to heminetwork folder..."
    mkdir -p "$HOME/heminetwork"
    tar -xzf /tmp/heminetwork_v0.6.0_linux_amd64.tar.gz -C "$HOME/heminetwork" --strip-components=1
    ...
    echo "更新到 v0.6.0 完成，并重新启动 popmd。/ Update to v0.6.0 completed and popmd restarted."
}
...
main_menu() {
    while true; do
        ...
        echo "6. 更新到 v0.6.0 / Update to v0.6.0"
        echo "7. 退出 / Exit"
