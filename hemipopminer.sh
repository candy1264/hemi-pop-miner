...
# 功能6：更新到 V0.4.5
update_to_v038() {
    echo "开始更新到 V0.4.5 / Starting update to V0.4.5"
    ...
    # 下载并解压 V0.4.5 版本
    echo "下载 V0.4.5 版本的压缩包... / Downloading V0.4.5 version archive..."
    wget https://github.com/hemilabs/heminetwork/releases/download/V0.4.5/heminetwork_V0.4.5_linux_amd64.tar.gz -O /tmp/heminetwork_V0.4.5_linux_amd64.tar.gz

    echo "解压 V0.4.5 版本的压缩包到 heminetwork 文件夹... / Extracting V0.4.5 version archive to heminetwork folder..."
    mkdir -p "$HOME/heminetwork"
    tar -xzf /tmp/heminetwork_V0.4.5_linux_amd64.tar.gz -C "$HOME/heminetwork" --strip-components=1
    ...
    echo "更新到 V0.4.5 完成，并重新启动 popmd。/ Update to V0.4.5 completed and popmd restarted."
}
...
main_menu() {
    while true; do
        ...
        echo "6. 更新到 V0.4.5 / Update to V0.4.5"
        echo "7. 退出 / Exit"
